 ...
 *******************************************************************************/
package net.sf.eclipsensis.updater.scheduler;

import java.lang.reflect.Constructor;
import java.util.Calendar;

import net.sf.eclipsensis.updater.EclipseNSISUpdatePlugin;
import net.sf.eclipsensis.updater.jobs.NSISUpdateJobSettings;
import net.sf.eclipsensis.updater.preferences.IUpdatePreferenceConstants;
...
public class Scheduler implements IStartup, IUpdatePreferenceConstants
{
    ...
    private Job createUpdateJob(final NSISUpdateJobSettings settings)
    {
        ...
        Runnable r= new Runnable() {
            ...
            {
                try {
                    Class<? extends Job> theClass = (Class<? extends Job>) Class.forName("net.sf.eclipsensis.updater.jobs.NSISCheckUpdateJob"); //$NON-NLS-1$
